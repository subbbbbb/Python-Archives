def getTranslatedMessage(mode, message, key):  # translator method
    ...
    # make sure the return statement is not inside the for loop, because then it would only return the first translated message then never include anything else
